...
ifeq ($(config),debug)
  CXX        = g++
  AR         = ar
  OBJDIR     = ../.temp/build/debug/simpletestproject_linux_gcov
  TARGETDIR  = ../.temp/bin
  TARGET     = $(TARGETDIR)/simpletestproject_linux_gcov_debug
  DEFINES   += 
  INCLUDES  += -I../simpletest
  CPPFLAGS  += -MMD -MP $(DEFINES) $(INCLUDES)
  CFLAGS    += $(CPPFLAGS) -std=c++11 -g -Wall -Werror -pthread -fprofile-arcs -ftest-coverage
...
ifeq ($(config),release)
  CXX        = g++
  AR         = ar
  OBJDIR     = ../.temp/build/release/simpletestproject_linux_gcov
  TARGETDIR  = ../.temp/bin
  TARGET     = $(TARGETDIR)/simpletestproject_linux_gcov_release
  DEFINES   += 
  INCLUDES  += -I../simpletest
  CPPFLAGS  += -MMD -MP $(DEFINES) $(INCLUDES)
  CFLAGS    += $(CPPFLAGS) -std=c++11 -g -O3 -Wall -Werror -pthread -fprofile-arcs -ftest-coverage
  CXXFLAGS  += $(CFLAGS) -fexceptions -fno-rtti 
  LDFLAGS   += -pthread -fprofile-arcs -ftest-coverage
  LIBS      +=  
  RESFLAGS  += $(DEFINES) $(INCLUDES)
